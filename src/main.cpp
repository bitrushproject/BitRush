...
const string strMessageMagic = "BitRush Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if (pindexBest->nHeight+1 <= 11440)
    {
      nSubsidy = 20 * COIN;
      return nSubsidy + nFees;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BitRush", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Thu, 09 Apr 2015 14:48:48 GMT";
        CTransaction txNew;
        txNew.nTime = 1428590928;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1428590933;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 6351125;
		if(fTestNet)
        {
            block.nNonce   = 6351125;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xa1f4a412098912964202d61fbaaf7c4c0faad93586cbd64651ba5a207afd06ba"));
        block.print();
